...
NTC for water temp. Both these sensors has M10x1 (fine pitch) thread.    
 
MAX6675+Thermocouple for EGT. 
Mondokart's "Sondagas" with green wire works fine for me.
...
More documents are available online for the LSU4.9 than for the LSU ADV.  
The main difference 4.9 vs ADV is supposed to be:
